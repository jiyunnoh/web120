...
<div class="wrapper">
<header>
  <h1><a href="index.php"><img class="logo" src="images/goodsbooks.png" alt="goodsbooks's logo"></a></h1>
    <div class="icon">
...
<!--        <span>Sign In</span>-->
  ...
  <ul>
     ...
     <li><a href="#"><span>Product <i class="fa fa-fw fa-chevron-down"></i></span></a>
        <ul>
           <li><a href="bookmark.php"><span>Bookmark</span></a></li>
           <li><a href="bookstand.php"><span>Book Stand</span></a></li>
